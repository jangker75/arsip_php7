...
use stdClass;
	...
	class AdminContactUsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Token Expired','name'=>'token_expired','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
	    ...
	    */
		...
		{
			$listContact = DB::table('kontak_informasi')->get();
			$listImg = new stdClass();
			$listImg->request = asset("asset/contactus.png");
			$listImg->helpdesk = asset("asset/contactus1.png");
