<?php namespace App\Http\Controllers;
	...
	class AdminHistoryUpdateBoxController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "history_update_box";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Tanggal Update","name"=>"created_at"];
			...
			$this->form[] = ['label'=>'Jenis Dok Id','name'=>'jenis_dok_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'jenis_dokumen,id'];
			$this->form[] = ['label'=>'Status Id','name'=>'status_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'status,nama'];
			...
			$this->form[] = ['label'=>'Jumlah Bantex','name'=>'jumlah_dok','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Tanggal Pemindahan','name'=>'tgl_pemindahan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Jenis Dok Id","name"=>"jenis_dok_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"jenis_dok,id"];
			//$this->form[] = ["label"=>"Status Id","name"=>"status_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"status,nama"];
			...
			//$this->form[] = ["label"=>"Tanggal pemindahan","name"=>"tgl_pemindahan","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
