<?php namespace App\Http\Controllers;
	...
	class AdminUnitKerjaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Client','name'=>'client_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cabang,nama','parent_select'=>'client_id'];
			$this->form[] = ['label'=>'Cabang','name'=>'cabang_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
