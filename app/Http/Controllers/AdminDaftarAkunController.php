<?php namespace App\Http\Controllers;
	...
	class AdminDaftarAkunController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cabang','name'=>'cabang_id','type'=>'select','validation'=>'|integer|min:0','width'=>'col-sm-10','datatable'=>'cabang,nama','parent_select' => 'client_id', 'help'=>'Kosongkan saja jika privilegesnya MDS'];
