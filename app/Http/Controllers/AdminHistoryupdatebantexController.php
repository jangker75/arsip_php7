<?php namespace App\Http\Controllers;
	...
	class AdminHistoryupdatebantexController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "history_update_box_detail";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			// $this->col = [];
			// $this->col[] = ["label"=>"Box Id","name"=>"box_id","join"=>"box,nama"];
			...
			$this->col[] = ["label"=>"Nomor Box","name"=>"box_id","join"=>"box,kode_box"];
			$this->col[] = ["label"=>"Kode Box","name"=>"box_id","join"=>"box,kode_box_sistem"];
			// $this->col[] = ["label"=>"Nomor Box","name"=>"box_id","join"=>"box,kode_box"];
			$this->col[] = ["label"=>"Nomor Rak","name"=>"box_id","join"=>"box,nomor_rak"];
			$this->col[] = ["label"=>"Tanggal Pemindahan","name"=>"box_id","join"=>"box,tgl_pemindahan"];
			...
			$this->col[] = ['label'=>'Tanggal Input','name'=>'created_at',"join"=>"box,created_at"
			,'callback_php'=>'date("d-m-Y",strtotime($row->created_at))'];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Box','name'=>'box_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'box,nama'];
			...
			$this->form[] = ['label'=>'Sequence','name'=>'sequence','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Sequence","name"=>"sequence","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
